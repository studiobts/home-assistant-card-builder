            ...
            if (blockEl) {
                try {
                    applyChartStyleTargetsToOption({
                        ...
                        getLegendLabelStyle: () => this._getChartTargetStyle(blockEl, 'getLegendLabelStyleTargetId'),
                        getLegendValueStyle: () => this._getChartTargetStyle(blockEl, 'getLegendValueStyleTargetId'),
                        getLegendUnitStyle: () => this._getChartTargetStyle(blockEl, 'getLegendUnitStyleTargetId'),
