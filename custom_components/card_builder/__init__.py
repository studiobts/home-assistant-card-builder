...
def _with_frontend_version(url_path: str) -> str:
    """Append the integration version to a frontend asset URL."""
    version = quote(CARD_BUILDER_INTEGRATION_VERSION, safe="")
...
async def async_setup_entry(hass: HomeAssistant, entry) -> bool:
    ...
    card_renderer_url = _with_frontend_version(CARD_RENDERER_SCRIPT_URL)
    frontend.add_extra_js_url(hass, card_renderer_url)

    # Register the custom panel
    panel_module_url = _with_frontend_version(PANEL_SCRIPT_URL)
